...
goats_tiago = Goat.create(user: owner_tiago, location: 'Nelas', number: 100, description: 'Cabras devoradoras', price: 50)
...
goats_felipe = Goat.create(user: owner_felipe, location: 'Lagos, Portugal', number: 50, description: 'Cabras calmas', price: 60)
...
goats_diogo = Goat.create(user: owner_diogo, location: 'Castelo Branco', number: 150, description: 'Cabras mortas de fome', price: 55)
